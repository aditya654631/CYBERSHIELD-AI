...
def downgrade():
    ...
    op.drop_index("ix_evidence_files_created_at", table_name="evidence_files")
    ...
    op.drop_index("ix_evidence_files_storage_key", table_name="evidence_files")
    op.drop_index("ix_evidence_files_complaint_id", table_name="evidence_files")
