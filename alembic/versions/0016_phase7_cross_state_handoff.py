...
def upgrade():
    ...
    op.create_index("ix_case_handoffs_comp_status", "case_handoffs", ["complaint_id", "status"])
    op.create_index("ix_case_handoffs_dest_status", "case_handoffs", ["destination_organization_id", "status"])
    op.create_index("ix_case_handoffs_origin_status", "case_handoffs", ["origin_organization_id", "status"])
    op.create_index("ix_case_handoffs_deadline", "case_handoffs", ["status", "acknowledgement_deadline"])


def downgrade():
    op.drop_index("ix_case_handoffs_deadline", table_name="case_handoffs")
    op.drop_index("ix_case_handoffs_origin_status", table_name="case_handoffs")
    op.drop_index("ix_case_handoffs_dest_status", table_name="case_handoffs")
    op.drop_index("ix_case_handoffs_comp_status", table_name="case_handoffs")
    op.drop_index("ix_case_handoffs_created_at", table_name="case_handoffs")
    op.drop_index("ix_case_handoffs_acknowledgement_deadline", table_name="case_handoffs")
    op.drop_index("ix_case_handoffs_status", table_name="case_handoffs")
    op.drop_index("ix_case_handoffs_recipient_user_id", table_name="case_handoffs")
    op.drop_index("ix_case_handoffs_initiator_user_id", table_name="case_handoffs")
    op.drop_index("ix_case_handoffs_destination_organization_id", table_name="case_handoffs")
    op.drop_index("ix_case_handoffs_origin_organization_id", table_name="case_handoffs")
    op.drop_index("ix_case_handoffs_complaint_id", table_name="case_handoffs")
    op.drop_index("ix_case_handoffs_id", table_name="case_handoffs")
